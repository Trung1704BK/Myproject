...
exports.createItem = async (req, res, next) => {
    try {
        const {name, ownerType, materialId, original, ageId, itemType, dimension, weight, description, audio, collected_date} = req.body;
        ...
        const featureImageUrl = res.locals.resultFeatureImage[0].key;
